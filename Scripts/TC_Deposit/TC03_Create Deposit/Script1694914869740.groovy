...
Mobile.selectListItemByLabel(findTestObject('Deposit/Deposit_dropdown-Bank Acc'), 'Bank Acc A ($50000.00)', 15)

Mobile.tap(findTestObject('Deposit/Deposit_dropdown-Bank Acc A'), 0)
